...
+ (void)showWithTip:(NSString *)tip {
    ...
    CGFloat width = [tip StringWidthWithFontSize:font] + 16;
    QJToast *toast = [[QJToast alloc] initWithFrame:CGRectMake(UIScreenWidth() / 2 - (width / 2), UIScreenHeight() - 85, width, 30)];
    toast.font = font;
    toast.text = tip;
    [toast show];
}
